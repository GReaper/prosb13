...
public class PorteroVity extends Behaviour
{
	...
	public int takeStep() 
	{
		myRobotAPI.setDisplayString("Portero");
		...
		{
			myRobotAPI.setSteerHeading(ayuda.irAPosicionParando(myRobotAPI.toFieldCoordinates(ourgoal), myRobotAPI,0.001));

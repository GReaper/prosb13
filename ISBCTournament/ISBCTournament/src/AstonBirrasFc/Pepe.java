...
public class Pepe extends Behaviour
{
	...
	private enum Estados {BloquearRival,EsperarRival};
	private Estados estado;
	private ArrayList<Integer>  cerca;
	
	public void configure() 
	{ 
		ayudas = new Ayudas();
		cerca=new ArrayList<Integer>();
	}
	...
	private Estados calculaEstado()
	{
		...
		if(!cerca.isEmpty())
		{
			//devuelve bloquearRival
			return Estados.BloquearRival;
		}
		
		//Devuelve el por defecto que es esperar
		return Estados.EsperarRival;
	}
